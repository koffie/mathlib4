...
class LinearOrderedAddCommMonoid (α : Type _) extends OrderedAddCommMonoid α, LinearOrder α
...
@[to_additive]
class LinearOrderedCommMonoid (α : Type _) extends OrderedCommMonoid α, LinearOrder α
