...
class LinearOrderedAddCommMonoid (α : Type _) extends AddCommMonoid α, LinearOrder α,
    OrderedAddCommMonoid α
#align linear_ordered_add_comm_monoid LinearOrderedAddCommMonoid

/-- A linearly ordered commutative monoid. -/
@[to_additive]
class LinearOrderedCommMonoid (α : Type _) extends CommMonoid α, LinearOrder α,
    OrderedCommMonoid α
...
class LinearOrderedAddCommMonoidWithTop (α : Type _) extends AddCommMonoid α, LinearOrder α,
