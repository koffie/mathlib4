...
variable (K : Type _) [CommRing K] [Algebra R K] [IsFractionRing R K]
...
variable {K : Type _} [CommRing K] [Algebra R K] [ifr : IsFractionRing R K]
...
theorem exists_algebraMap_eq_of_pow_mem_subalgebra {K : Type _} [CommRing K] [Algebra R K]
